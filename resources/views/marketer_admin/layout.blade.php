...
@include('marketer_admin.layouts.header')
...
<div id="layout-wrapper">
    ...
    <!-- Navbar ---- -->
@include('marketer_admin.layouts.navbar')


<!-- ========== Left Sidebar Start ========== -->

    @include('marketer_admin.layouts.sidebar')
...
<!-- Left Sidebar End -->
    ...
    <div class="main-content"  >
        ...
        @yield('breadcrumb')
        @include('marketer_admin.layouts.message')
        @yield('content')

        <!-- End Page-content -->

            <!-- footer -->
            @include('marketer_admin.layouts.footer')
        </div>
...
<!-- Right Sidebar -->
@include('marketer_admin.layouts.right-sidebar')
...
<!-- JAVASCRIPT -->
@include('marketer_admin.layouts.script')
@livewireScripts
<script>
    // livewire events
