...
{{--                @endforeach--}}
        ...
        <div class="p-4">
            <div class="mb-2">
                <img src="{{ asset('images/layouts/layout-1.jpg') }}" class="img-fluid img-thumbnail" alt="Layouts-1">
            </div>
            ...
            <div class="mb-2">
                <img src="{{ asset('/images/layouts/layout-2.jpg') }}" class="img-fluid img-thumbnail" alt="Layouts-2">
            </div>
