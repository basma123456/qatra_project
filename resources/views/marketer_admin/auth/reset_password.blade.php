        ...
        <div class="col-md-4 mt-5">
            ...
            <div class="card">
                <div class="card-body mt-4">
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('marketer_admin.reset_password_show_email_page_store') }}" method="POST">
                        @csrf
                    ...
                    <a style="width: 60px !important;" class="btn w-25 text-center  btn-outline-orange d-grid w-100 btn" href="{{url('marketer_admin/login')}}">       رجوع </a>
