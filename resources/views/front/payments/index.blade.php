...
@section('content')
    <main class="main-wrap payment-page mb-xxl">
        <form action="{{ route('front.payment.check', $order->id) }}" id="form_3" method="POST">
            ...
            <section class="order-detail mt-3">
                <h3 class="title-2">هل لديك كوبون هدايا ؟
                </h3>
                <!-- Product Detail  Start -->
                    ...
                    <div class="custom-form">
                        ...
                        <div class="row">
                            <div class="col-8 mb-2">
                                <div class="input-box mb-0">
                                    <input name="coupon" id="coupon" class=" form-control" type="text" />
                                </div>
                            </div>

                            <div class="col-4 my-2">
                                <button class="btn btn-primary w-100" id="coupon_apply">تطبيق</button>
            ...
            <section class="order-detail mt-3">
                ...
                <ul>
                    ...
                    <li>
                        <span>الإجمالي</span>
                        <span>{{ number_format($shoppingCart->getTotal() + $order->tax, 2) }}</span>
                    </li>
