    ...
    <main class="main-wrap payment-page mb-xxl">
        <section class="payment-section py-0">
            ...
            <div class="accordion" id="accordionExample">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingiphone">
                            <button class="accordion-button font-md title-color" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseiphone" aria-expanded="true"
                                    aria-controls="collapseiphone">
                        ...
                        <div id="collapseiphone" class="accordion-collapse collapse show"
                             aria-labelledby="headingiphone"
                ...
                @if ($iphone && !$safari)
                    <div class="accordion-item">
                        ...
                        <div id="collapseiphone" class="accordion-collapse collapse show"
                             ...
                             data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <p class="text-danger"><i class="ri-information-line"></i> تنويه: للدفع بواسطة أبل باي
                                    يجب
                                    عليك استخدام متصفح سفاري فقط
                                </p>
                                <p class="text-secondary">في حال دخولك لهذه الصفحة من خلال سناب شات أو أي تطبيق آخر،
                                    يمكنك
                        ...
                        <div class="accordion-body">
                            <div class="offcanvas-body small">
                                <div class="custom-form">
                                    ...
                                    <button id="tap-btn" disabled class="disableafterclickpay">إرسال</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Accordion Start -->
                @if (app('request')->input('transfer') == 101)
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwo">
                            <button class="accordion-button font-md title-color collapsed" type="button"
                                ...
                                <svg style="width: 40px; height: 40px;margin-left: 10px;"
                                     ...
                                     version="1.1" id="mdi-bank-transfer" width="24" height="24"
                                     viewBox="0 0 24 24">
                                    <path
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-box col-12">
                                            ...
                                            <div class="drop_box">
                                                ...
                                                <input id="transfer_img" type="file" hidden
                                                       accept=".jpg,.jpeg,.pdf,.png" style="display:none;"
                                                       name="transfer_img" onchange="previewImage(this)"
...
@section('js')
    ...
    <script>
        ...
        const {unmount} = renderTapCard('card-sdk-id', {
            publicKey: '{{config("tap.public_key")}}',
            merchant: {
                id: '18926073'
            },
            transaction: {
            ...
            onInvalidInput: (data) => {
                if (data) {
                    $('.disableafterclickpay').prop("disabled", true);
                } else {
                    $('.disableafterclickpay').prop("disabled", false);
                }
            },
            onError: (data) => console.log('onError', data),
            onSuccess: (data) => {
                tapTokenHandler(data)
        ...
        ttq.track('AddPaymentInfo', {
            "contents": [
                    @foreach ($order->details as $item)
                {
                    "content_id": "{{ $item->product_id }}", // string. ID of the product. Example: "1077218".
                    "content_type": "product", // string. Either product or product_group.
                    "content_name": "{{ $item->title }}" // string. The name of the page or product. Example: "shirt".
                }
                @if (!$loop->last)
                ,
                @endif
            ...
            "value": "{{ $order->total }}", // number. Value of the order or items sold. Example: 100.
