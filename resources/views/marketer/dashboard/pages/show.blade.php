...
@section('title_page', " صفحة  " .  @$page->title  )
                                                            ...
                                                            <div class="row mb-3 slug-section">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea id="content" name="content" disabled> {{ @$page->content }} </textarea>
                                                ...
                                                <div id="collapseTwo"
                                                    ...
                                                    <div class="accordion-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea name="meta_description" class="form-control description" disabled> {{ @$page->meta_description }} </textarea>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea name="meta_key" class="form-control description" disabled> {{ @$page->meta_key }} </textarea>
