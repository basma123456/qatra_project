...
@section('title', "تعديل منيو")
@section('title_page',"تعديل منيو")
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control title" type="text" name="title" value="{{ @$menu->title }}" id="title">
                                                    ...
                                                    <div class="row mb-3 slug-section">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="slug" value="{{ @$menu->slug }}" id="slug" class="form-control slug" required>
                                                        </div>
                                                        @if ($errors->has('slug'))
