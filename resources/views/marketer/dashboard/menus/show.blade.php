...
@section('title', "عرض المنيو")
@section('title_page',"عرض المنيو")
                                    ...
                                    <div class="accordion-item border rounded">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                ...
                                                {{-- title ------------------------------------------------------------------------------------- --}}
                                                <div class="row mb-3">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">{{ trans('admin.title_in')  }}</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" name="title" disabled value="{{ $menu->title }}" id="name">
                                                    </div>
                                                ...
                                                <div class="row mb-3 slug-section">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">{{ trans('admin.slug_in')  }}</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="slug" value="{{ $menu->slug }}" id="slug" disabled class="form-control slug" required>
                                                    </div>
