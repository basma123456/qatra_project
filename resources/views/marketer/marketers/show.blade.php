...
@section('title')
    {{$marketer->name}}     عرض بيانات المسوق
@endsection
@section('css')
@endsection
@section('breadcrumb')
...
@section('content')
    <div class="card mb-4">
        <h5 class="card-header">     عرض بيانات المسوق    {{$marketer->name}}    </h5>
        <div class="card-body" >
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input disabled  type="text" name="name" value="{{ old('name',$marketer->name) }}"
                ...
                <div class="col-md-3">
                    ...
                    <input disabled  type="number" name="mobile" value="{{ old('mobile',$marketer->mobile) }}"
                ...
                <div class="col-md-3">
                    ...
                    <input disabled  type="email" name="email" value="{{ old('email',$marketer->email) }}"
