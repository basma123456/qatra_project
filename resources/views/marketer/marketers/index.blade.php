...
{{--                                    <a class="dropdown-item" href="{{ route('marketer_admin.coupon.create', $marketer->id) }}"><i--}}
{{--                                            class="bx bx-plus me-1"></i>--}}
{{--                                        إضافة كوبون</a>--}}
{{--                                    <a class="dropdown-item" href="{{ route('marketer_admin.marketer.edit', $marketer->id) }}"><i--}}
{{--                                            class="bx bx-edit-alt me-1"></i>--}}
{{--                                        تعديل</a>--}}
{{--                                    <a class="dropdown-item confirm-delete"--}}
{{--                                       href="{{ route('marketer_admin.marketer.delete', $marketer->id) }}"><i--}}
