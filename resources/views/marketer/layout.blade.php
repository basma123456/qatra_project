...
@include('marketer.layouts.header')
...
<div id="layout-wrapper">
    ...
    <!-- Navbar ---- -->
@include('marketer.layouts.navbar')


<!-- ========== Left Sidebar Start ========== -->

    @include('marketer.layouts.sidebar')
...
<!-- Left Sidebar End -->
    ...
    <div class="main-content"  >
        ...
        @yield('breadcrumb')
        @include('marketer.layouts.message')
        @yield('content')

        <!-- End Page-content -->

            <!-- footer -->
            @include('marketer.layouts.footer')
        </div>
...
<!-- Right Sidebar -->
@include('marketer.layouts.right-sidebar')
...
<!-- JAVASCRIPT -->
@include('marketer.layouts.script')
@livewireScripts
<script>
    // livewire events
