...
@endsection
@section('content')
    <main class="main-wrap order-tracking-page  mb-xxl">
        ...
        <section class="location-section">
            ...
            <ul class="tracking-box">
                <li class="media">
                    ...
                    <div class="media-body">
                        ...
                        <span class="font-sm content-color">17:40 الاثنين 10 فبراير 2022</span>
                ...
                <li class="media">
                    ...
                    <div class="media-body">
                        ...
                        <span class="font-sm content-color">17:40 الثلاثاء 11 فبراير 2022</span>
                    </div>
                </li>
                <li class="media">
            ...
            {{-- <a href="order-detail.html" class="btn-solid">Order Details</a> --}}
            ...
            <div class="row justify-content-center text-center bk_gallery">
                ...
                <div class="col-12">
                    <div id="aniimated-thumbnials" class="items_gallery">
                        ...
                        <a href="{{ url('') }}/assets/images/track.jpeg" data-sub-html='2022-09-08 02:40 PM'>
                            <img src="{{ url('') }}/assets/images/track.jpeg" />
                ...
                <div class="col-12">
                    <p class="border rounded bg-light p-3 small text-start">
                        تم تسليم 20 كراتين ماء ومتبقي 10 أخرى
                        <br>
                        2022-09-03 12:34:00 PM
                    </p>
                    <p class="border rounded bg-light p-3 small text-start">
                        لم يتم التوصيل لعدم وجود الشخص المسؤول في المسجد
                        <br>
                        2022-09-02 12:34:00 PM
                    </p>
                </div>
            </div>
        </section>
