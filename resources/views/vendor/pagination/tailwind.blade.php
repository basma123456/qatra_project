...
@if ($paginator->hasPages())
    <div class="dataTables_paginate paging_simple_numbers m-3" id="DataTables_Table_0_paginate">
        <ul class="pagination">
            @if ($paginator->onFirstPage())
            ...
            @else
                <li class="paginate_button page-item previous" id="DataTables_Table_0_previous"><a
                        ...
                        tabindex="0" class="page-link">{!! __('pagination.previous') !!}</a>
                </li>
            @endif
            ...
            @foreach ($elements as $element)
                @if (is_string($element))
                    <li class="paginate_button page-item disabled"><a href="#" aria-controls="DataTables_Table_0"
                            data-dt-idx="4" tabindex="0" class="page-link">{{ $element }}</a></li>
                @endif
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <li class="paginate_button page-item active disabled "><a href="#"
            ...
            @if ($paginator->hasMorePages())
                <li class="paginate_button page-item next" id="DataTables_Table_0_next"><a
                        href="{{ $paginator->nextPageUrl() }}" aria-controls="DataTables_Table_0" data-dt-idx="8"
                        tabindex="0" class="page-link">{!! __('pagination.next') !!}</a>
                </li>
            @else
