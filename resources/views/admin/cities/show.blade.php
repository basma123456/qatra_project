                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" name="name_ar" disabled readonly value="{{ @$city->name_ar }}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" type="text" name="name_en" disabled readonly value="{{ @$city->name_en }}" </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-sm-10">
                                <div class="col-sm-10">
                                    <input class="form-check form-switch" name="status" type="checkbox" id="switch3" switch="success" {{ @$city->status == 1 ? 'checked' : '' }} value="1" disabled>
