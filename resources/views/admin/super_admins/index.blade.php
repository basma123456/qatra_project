                    ...
                    <div class="card-body  search-group">
                        <div class="row">
                            <div class="col-md-12 text-end mb-2">
                                <a href="{{ route('admin.super_admins.create') }}"
                                   class="btn btn-outline-success btn-sm">اضافة</a>
                            </div>
                        </div>
                        {{-- Start Form search --}}
                        <form action="{{route('admin.super_admins.index')}}" method="get">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-md-3 mb-2">
                                    <input type="test" value="{{ old('name', request()->input('name')) }}"
                                           name="name" placeholder="ابحث بالاسم"
                                           class="form-control">
                                </div>
                                ...
                                <div class="col-md-3 mb-2">
                                    <input type="text"
                                           ...
                                           name="email" placeholder="ابحث بالايميل"
                                           class="form-control">
                                </div>

                                <div class="col-md-3 mb-2">
                                    <input type="test"
                                           value="{{ old('mobile', request()->input('mobile')) }}"
                                           name="mobile" placeholder="ابحث بالجوال"
                                           class="form-control">
                                </div>
...
{{--                                </div>--}}
                                ...
                                <div class="search-input col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{route('admin.super_admins.index')}}"><i
                    ...
                    <div class="card-body mt-0 pt-0">
                        <form id="update-pages" action="{{route('admin.super_admins.actions')}}" method="post">
                            @csrf
                        </form>
...
{{--                                                    @if($item->status == 1)--}}
{{--                                                        <a href="{{ route('admin.super_admins.update-status', $item->id )}}"--}}
...
{{--                                                    @if($item->feature == 1)--}}
{{--                                                        <a href="{{ route('admin.super_admins.update-featured', $item->id )}}"--}}
...
{{--                                                    @endif--}}
                                                    ...
                                                    <a href="{{ route('admin.super_admins.show', $item->id) }}"
                                                       name="@lang('admin.show')"
                                                       class="btn btn-xs btn-outline-info btn-sm m-1"><i
                                                            class="fas fa-eye"></i></a>


                                                    <a href="{{ route('admin.super_admins.edit',$item->id) }}"
                                                       name="@lang('admin.edit')"
                                                       class="btn btn-outline-primary btn-sm m-1"><i
                                                            class="fas fa-pencil-alt"></i></a>

                                                    <a class="btn btn-outline-danger btn-sm m-1"
                                                       name="@lang('admin.delete')" data-bs-toggle="modal"
                                        ...
                                        @include('admin.super_admins.delete')
                                    @endif
