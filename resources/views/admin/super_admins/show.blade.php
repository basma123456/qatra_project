...
@section('title', "مدير رئيسي " . @$super_admin->name)
@section('title_page',   "مدير رئيسي " . @$super_admin->name )
            ...
            <div class="row">
                <div class="col-12 m-3">
                    <div class="row mb-3 text-end">
                        <div>
                            <a href="{{ route('admin.super_admins.index') }}" class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm">رجوع</a>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="name"
                                                                     disabled  value="{{ @$super_admin->name }}" id="name">
                                                            </div>
                                                            @if ($errors->has( 'name'))
                                                                <span
                                                        ...
                                                        <div class="row mb-3 slug-section">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" id="mobile" name="mobile"
                                                                       disabled    value="{{ @$super_admin->mobile }}"
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <input id="email"   disabled class="form-control"
                                                                          value="{{ @$super_admin->email }}"    name="email">
                                                                    @if($errors->has(  'email'))
                                                                        <span
