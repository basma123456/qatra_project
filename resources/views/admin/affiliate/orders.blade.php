            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body  search-group">
                        ...
                        {{-- Start Form search --}}
                        <form action="{{route('marketer.orders.index')}}" method="get">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2 mb-2">
                                    <select
                                        ...
                                        @forelse($paymentMethods as $payment_method)
                                            <option value="{{$payment_method->id}}" {{  request()->input('payment_type_id') == $payment_method->id}} > {{ $payment_method->name_ar  }}</option>
                                        @empty
                                ...
                                <div class="col-md-2 mb-2">
                                    ...
                                    @foreach($orderStatus as $order_status)
                                            <option value="{{$order_status->id}}" {{  request()->input('order_status_id') == $order_status->id}} > {{ $order_status->name_ar  }}</option>
                                        @endforeach
...
{{--                                </div>--}}
                                ...
                                <div class="search-input col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{route('marketer.orders.index')}}"><i
