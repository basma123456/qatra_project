    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">تعديل بطاقة</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.cards.edit',$card) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            <div class="mb-3">
                                ...
                                @if ($card->img)
                                    <img src="{{ url('storage/' . $card->img) }}" class="mt-3 img-fluid"/>
                                @endif
                            </div>
                        </div>
                        <div class="col-4 col-md-2">
                            ...
                            <label class="switch">
                                <input type="checkbox" class="switch-input" name="is_payment" value="1" @if ($card->is_payment) checked @endif />
                        ...
                        <div class="col-4 col-md-2">
                            ...
                            <label class="switch">
                                <input type="checkbox" class="switch-input" name="is_gift" value="1" @if ($card->is_gift) checked @endif  />
                                <span class="switch-toggle-slider">
                                    <span class="switch-on"></span>
                                    <span class="switch-off"></span>
                                </span>
                        ...
                        <div class="col-4 col-md-2">
                            ...
                            <label class="switch">
                                <input type="checkbox" class="switch-input" name="status" value="1" @if ($card->status) checked @endif />
                                <span class="switch-toggle-slider">
                                    <span class="switch-on"></span>
                                    <span class="switch-off"></span>
                                </span>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="text" rows="5">{{ $card->text }}</textarea>
                            </div>
                        </div>
                    </div>
