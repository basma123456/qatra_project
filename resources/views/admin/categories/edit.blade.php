...
@section('name_ar',   "تعديل قسم " . @$category->name_ar )
@section('name_ar_page', "تعديل قسم " .   @$category->name_ar  )
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="name_ar"
                                                                       value="{{ @$category->name_ar }}" id="title">
                                                            </div>
                                                ...
                                                <div class="accordion-item border rounded">
                                                    ...
                                                    <div id="collapseTwo" class="accordion-collapse collapse show mt-3"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label for="example-text-input"
                                                                       class="col-sm-2 col-form-label">عنوان الميتا</label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea name="meta_description"
                                                                              class="form-control description"> {{ @$category->meta_description }} </textarea>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea name="meta_key"
                                                                              class="form-control description"> {{ @$category->meta_key }} </textarea>
