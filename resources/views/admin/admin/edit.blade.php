...
@section('title_page', trans('admin.edit_user'))
        ...
        <div class="row">
            <div class="col-12">
                <div class="row mb-3 text-end">                                
                    <div>
                        <a href="{{ route('admin.admin.index') }}" class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
                    </div>
                </div>
                <div class="card">
                    <form action="{{ route('admin.admin.update',$admin->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row d-flex justify-content-center">
                                        ...
                                        <div class="accordion-item border rounded">
                                            <h2 class="accordion-header" id="headingOne">
                                                <button class="accordion-button fw-medium" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne1" aria-expanded="true" aria-controls="collapseOne1">
                                                 <span class=" text-success "> {{ $admin->name }}</span>
                                                </button>
                                            </h2>
                                            <div id="collapseOne1" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="example-email-input" class="col-sm-2 col-form-label">{{ trans('admin.email') }}</label>
                                                        <div class="col-sm-10">
                                                            <input class="form-control @error('email') is-invalid @enderror" type="email" value="{{$admin->email }}" name="email">
                                                            @error('email')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="example-tel-input" class="col-sm-2 col-form-label">{{ trans('admin.mobile') }}</label>
                                                        <div class="col-sm-10">
                                                            <input class="form-control  @error('mobile') is-invalid @enderror" type="tel" value="{{ $admin->mobile }}" name="mobile">
                                                            @error('mobile')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        </div>
                                    ...
                                    <div class="accordion-item border rounded">
                                        ...
                                        <div class="accordion-body">
                                            <div class="col-sm-3 mb-3">
                                                @if($admin->image != null)
                                                    <img src="{{asset( 'storage/'. $admin->image)}}" alt="" style="width:100%">
                                                @endif
                                            </div>
                                            {{-- image ------------------------------------------------------------------------------------- --}}
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <select type="text" class="form-control select_2" multiple required id="role " name="roles[]" >
                                                            @foreach($roles as $role)
                                                                  <option {{ $admin->roles->pluck('name')->contains($role->name) ? 'selected':'' }}
                                            ...
                                            {{-- Status ------------------------------------------------------------------------------------- --}}
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-check form-switch" name="status" type="checkbox" id="switch3" switch="success"   {{ @$admin->status == 1? 'checked':'' }}>
                            ...
                            <div class="row mb-3 text-end">                                
                                <div>
                                    <a href="{{ route('admin.admin.index') }}" class="btn btn-outline-primary waves-effect waves-light  btn-sm">@lang('button.cancel')</a>
