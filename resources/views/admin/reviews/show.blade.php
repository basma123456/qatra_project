                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="name_ar"
                                                                     disabled  value="{{ @$product->name_ar }}" id="name_ar">
                                                            </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea name="meta_description"
                                                                              disabled     class="form-control description"> {{ @$product->meta_description }} </textarea>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea name="meta_key"
                                                                              disabled              class="form-control description"> {{ @$product->meta_key }} </textarea>
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse show"
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="col-sm-3 mb-3">
                                                            ...
                                                            <img src="{{ asset($product->pathInView()) }}" alt=""
                                                                 style="width:100%">
                                                        ...
                                                        <div class="col-12 ">
                                                            <label class="col-md-3 col-form-label" for="feature"> ميزة </label>
                                                        ...
                                                        {{-- deliverable ------------------------------------------------------------------------------------- --}}
                                                        <div class="col-12 ">
                                                            <label class="col-md-3 col-form-label" for="deliverable">متاح للتوصيل</label>
                                                        ...
                                                        <div class="col-12 ">
                                                            <label class="col-md-3 col-form-label" for="no_carton">غير معلب</label>
