...
@section('title_review',  "تعديل رأي العميل " .  @$review->title  )
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="accordion mt-4 mb-4" id="accordionExample">
                                            ...
                                            <div class="accordion mt-4 mb-4" id="accordionExample">
                                                ...
                                                {{--                                                                                class="form-control description"> {{ @$review->meta_description }} </textarea>--}}
                                                ...
                                                {{--                                                                                      class="form-control description"> {{ @$review->meta_key }} </textarea>--}}
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="form-control" name="gender"
                                                                        id="gender">
                                                                    <option
                                                                        {{$review->gender === 0 ? 'selected' : ''}} value="0">
                                                                        ذكر
                                                                    </option>
                                                                    <option
                                                                        {{$review->gender === 1 ? 'selected' : ''}} value="1">
                                                                        انثي
                                                                    </option>
                                                                </select>
                                                            </div>
