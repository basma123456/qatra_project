...
@section('title_review', "انشئ رأي العميل")
                                                            ...
                                                            <div class="row mt-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea id="description" name="description"
                                                                              ...
                                                                              style="margin-top: 10px"> {{ old(  'description') }} </textarea>
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="col-12">
                                                            <label class="col-sm-12 col-form-label"
                                                                   for="feature">الميزة</label>
                                                            <div class="col-sm-10">
                                                                <input class="form-check form-switch" name="feature"
                                                                       type="checkbox" id="feature" switch="success"
                                                                       checked value="1">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="form-control" name="rate"
                                                                        id="rate">
                                                                    <option
                                                                        {{old('rate') === 1 ? 'selected' : ''}} value="1">
                                                                        1
                                                                    </option>
                                                                    <option
                                                                        {{old('rate') === 2 ? 'selected' : ''}} value="2">
                                                                        2
                                                                    </option>
                                                                    <option
                                                                        {{old('rate') === 3 ? 'selected' : ''}} value="3">
                                                                        3
                                                                    </option>
                                                                    <option
                                                                        {{old('rate') === 4 ? 'selected' : ''}} value="4">
                                                                        4
                                                                    </option>
                                                                    <option
                                                                        {{old('rate') === 5 ? 'selected' : ''}} value="5">
                                                                        5
                                                                    </option>
                                ...
                                <div class="row mb-3 text-end">
                                    <div>
                                        <a href="{{ route('admin.reviews.index') }}"
                                           class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm">رجوع</a>
                                        <button type="submit"
                                                class="btn btn-outline-success waves-effect waves-light ml-3 btn-sm">حفظ
                                        </button>
                                    </div>
                                </div>
                            </form>
