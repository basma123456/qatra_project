                    ...
                    <div class="row">
                        ...
                        @foreach ($order->images as $image)
                            <div class="col-md-6 col-12 mb-2">
                                ...
                                <a class="btn btn-danger mt-2 mb-5"
                                    href="{{ route('admin.order.deleteImage', $image->id) }}">حذف الصورة</a>
                            </div>
                        @endforeach
                        <div class="col-12 mb-2">
                            <form action="{{ route("admin.order.addImage",$order->id) }}" method="POST"  enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
