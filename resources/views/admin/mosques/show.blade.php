...
@section('title', "منتج " . @$mosque->name_ar)
@section('title_page',   "منتج " . @$mosque->name_ar )
@section('breadcrumb')
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input disabled type="text" name="name_ar" value="{{ old('name_ar',$mosque->name_ar) }}"
                    ...
                    <div class="col-md-3">
                        ...
                        <input disabled type="text" name="name_en" value="{{ old('name_en',$mosque->name_en) }}"
                    ...
                    <div class="col-md-3">
                        ...
                        <select disabled name="district_id"
                                class="select2 form-select @error('district_id') is-invalid @enderror"
                                data-allow-clear="true">
                            <option value="">اختر الحي</option>
                            @foreach ($districts as $district)
                                <option @if (old('district_id',$mosque->district_id) == $district->id) selected
...
{{--                        <input disabled id="longitude" name="longitude" type="text"--}}
...
{{--                        <input disabled id="latitude" name="latitude" type="text"--}}
...
{{--                    </div>--}}
                    ...
                    <div class="col-md-4">
                        ...
                        <input disabled name="rows" type="text" value="{{ old('rows',$mosque->rows) }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <input disabled name="row_length" type="text"
                    ...
                    <div class="col-md-12">
                        <label class="switch switch-primary">
                            <input disabled type="checkbox" class="switch-input" name="status"
                    ...
                    <div class="col-md-12">
                        <label class="switch switch-primary">
                            <input disabled type="checkbox" class="switch-input" name="is_full"
                    ...
                    <div class="col-md-12">
                        <label class="switch switch-primary">
                            <input disabled type="checkbox" class="switch-input" name="high_need"
