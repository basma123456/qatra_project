<div class="modal fade" id="exampleModal{{ $mosque->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer" >
            <form  action="{{ route('admin.mosque.destroy' , $mosque->id) }}" method="POST">
                @csrf
                @method('DELETE')
